...
@Component
public class SenderMessageCotizacion implements MessageSender<Object> {

    private final RabbitTemplate rabbitTemplate;
    private final MapperJsonObjeto mapperJsonObjeto;

    public SenderMessageCotizacion(RabbitTemplate rabbitTemplate, MapperJsonObjeto mapperJsonObjeto){
